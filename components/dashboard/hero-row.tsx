...
export function HeroRow({ profile, stats }: HeroRowProps) {
  ...
  return (
    <div className="card-base flex flex-col gap-3 p-4 sm:flex-row sm:items-center sm:gap-4">
      ...
      >
        {/* Shimmer reflection */}
        <div className="absolute inset-0 -translate-x-[150%] bg-gradient-to-r from-transparent via-black/15 dark:via-white/40 to-transparent w-1/2 h-full skew-x-[-15deg] animate-shimmer-fast pointer-events-none" />
