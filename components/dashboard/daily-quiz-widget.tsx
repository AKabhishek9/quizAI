            ...
            return (
              ...
              >
                <Link href={`/quiz/daily/${quiz.id}`}>
                  <div className="group flex flex-col gap-2 p-4 border border-border rounded-lg bg-card hover:border-primary/40 hover:bg-card/80 transition-colors duration-150 cursor-pointer">
