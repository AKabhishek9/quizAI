  ...
  return (
    <div className="min-h-[80vh] flex items-center justify-center p-4">
      <motion.div 
        ...
        className="w-full max-w-md bg-card border border-border p-8 rounded-2xl elevated relative overflow-hidden"
      >
        ...
        <div className="relative z-10 space-y-6">
          <div className="text-center space-y-2">
            ...
            <p className="text-sm text-muted-foreground">
              {isLogin 
                ? "Securely access your personalized quiz AI" 
                : "Sign up to track your adaptive knowledge graph"
              }
            </p>
          </div>
          ...
          <form onSubmit={handleEmailAuth} className="space-y-4">
            ...
            <Button disabled={isLoading} className="w-full h-11 font-medium glow">
